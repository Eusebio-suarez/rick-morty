...
async function renderCaracters(url) {
    ...
    caracters.forEach(caracter => {
        ...
        card.innerHTML = `
            ...
            <div class = "flex">
                <h2 class="text-center text-base font-semibold text-blue-100 mt-4 break-words mr-1 ">#${caracter.id}</h2>
                <h2 class="text-center text-base font-semibold text-blue-800 mt-4 break-words">${caracter.name}</h2>
            </div>
            <div>
