    ...
    caracters.forEach(caracter => {
        ...
        card.innerHTML = `
           <img class="w-[120px] h-[120px] object-cover rounded-full" src="${caracter.image}" alt="${caracter.name}">
            <div class="flex">
                <h2 class="text-center text-base font-semibold text-gray-600 mt-4 break-words mr-1">#${caracter.id}</h2>
                <h2 class="text-center text-base font-semibold text-gray-900 mt-4 break-words">${caracter.name}</h2>
            </div>
            <div>
                <h2 class="text-center text-base font-semibold text-gray-800 break-words">${caracter.species}</h2>
                <h2 class="text-center text-base font-semibold text-blue-700 break-words">${caracter.gender}</h2>
            </div>
        `;
